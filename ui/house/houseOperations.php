...
function handleUpdateRequest() {
    ...
    $rentalunits = $_POST['rentalunits'];

    $query = "UPDATE house SET";
    //
    if ($rentalunits != "") { 
        $query = $query . " rentalunits='".$rentalunits."'";
    } 
    ...
    // executePlainSQL("UPDATE house SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into house values (:bind1, :bind2)", $alltuples);
    OCICommit($db_conn);
}
