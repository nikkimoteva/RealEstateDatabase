...
function handleUpdateRequest() {
    ...
    if ($rating != "") { 
        ...
        $query = $query .  " lawschool='".$lawschool."'";
    } 
    ...
    // executePlainSQL("UPDATE lawyer SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    $tuple = array (
        ":bind1" => $_POST['lawyerid'],
        ":bind2" => $_POST['rating'],
        ":bind3" => $_POST['cost'],
        ":bind4" => $_POST['lawschool'],
    );
    ...
    executeBoundSQL("insert into lawyer values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
    OCICommit($db_conn);
}
...
function handleSelectRequest() {
    ...
    $query = "SELECT * FROM lawyer WHERE" ;
