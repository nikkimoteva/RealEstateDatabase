...
function handleUpdateRequest() {
    ...
    $query = "UPDATE branchLocation SET";
    //
    if ($country != "") { 
    ...
    // executePlainSQL("UPDATE branchLocation SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into branchLocation values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
    OCICommit($db_conn);
}
...
function handleSelectRequest() {
    ...
    $query = "SELECT * FROM branchLocation WHERE" ;
...
function handleDeleteRequest() {
    ...
    $query = "DELETE FROM branchLocation WHERE address='" . $address . "'";
    echo $query;
    executePlainSQL($query);
...
if (isset($_POST['select']) || isset($_POST['insert']) || isset($_POST['update'])|| isset($_POST['delete'])) {
    ...
    if(connectToDB()) {
        $result = executePlainSQL("select * from branchLocation");
        printResult($result);
    }
