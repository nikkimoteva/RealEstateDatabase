...
function handleUpdateRequest() {
    ...
    // executePlainSQL("UPDATE employs SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into employs values (:bind1, :bind2)", $alltuples);
    OCICommit($db_conn);
}
...
function handleSelectRequest() {
    ...
    $query = "SELECT * FROM employs WHERE" ;
...
function handleDeleteRequest() {
    ...
    $query = "DELETE FROM employs WHERE agentID='" . $agentID . "'";
    echo $query;
    executePlainSQL($query);
...
if (isset($_POST['select']) || isset($_POST['insert']) || isset($_POST['update'])|| isset($_POST['delete'])) {
    ...
    if(connectToDB()) {
        $result = executePlainSQL("select * from employs");
        printResult($result);
    }
